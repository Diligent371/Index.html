...
<body>
    ...
    <div class="section">
        <h2>👨‍💻 I'm interested in the following basic fields:-
1. Basic of Machine Learning (ML): a primary method used to build AI systems today where engineers feed data to a computer model and allow it to learn the rules independently without programming explicit instructions/codes,
...
3. Generative AI: A modern branch of AI capable of creating original content. It powers systems that generate new text, images, music, and software code based on a prompt.=>am much interested to develop a chat bot.</h2>
        <ul>
    ...
    <div class="section">
        <h2>Links</h2>
        <ul>
            <li><a href="https://github.com/Diligent371">Diligent371</a></li>
        </ul>
    </div>
</body>
</html>
